...
export const calculateSuperMaxPrice = (durationInYears, currentYear) => {
  switch (durationInYears) {
    case 3:
      return Math.trunc(BASE_CAP_2024 * THREE_YEAR_RATES[currentYear - 1]);
    case 4:
      return Math.trunc(BASE_CAP_2024 * FOUR_YEAR_RATES[currentYear - 1]);
    case 5:
      return Math.trunc(BASE_CAP_2024 * FIVE_YEAR_RATES[currentYear - 1]);
    default:
      return 0;
  }
};
